...
def test_cadastro_execucao_spsadt_procedimento(execucao_spsadt_no_mark_parametrize_option_2,client_app):

        response = client_app.post(f"{settings.BASE_URL}/execucao_spsadt_procedimento", json={
