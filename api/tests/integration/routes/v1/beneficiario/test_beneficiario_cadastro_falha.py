...
@mark.parametrize(
    ...
    [
        (
            ...
            False,
            400,
            "O campo atendimento_rn deve ser um booleano !",
        )
    ],
)
def test_nao_deve_cadastrar_beneficiario_com_parametro_atendimento_rn_invalido(
...
def test_nao_deve_cadastrar_beneficiario_pois_o_valor_enviado_nao_e_um_numero_de_carteirinha(
