...
@mark.parametrize(
    "codigo_prestador_na_operadora,nome_contratado,carater_atendimento,tipo_atendimento,response",
    [
...
@mark.parametrize(
    ...
    [
        ...
        (
            ...
            "sdsdsd",
            "sdsdsdsdds",
            "O campo nome_contratado deve ser um texto !",
        ),
        (
            32323,
            "Maria",
...
def test_deve_ocorrer_falha_no_cadastro_dos_dados_do_contratado_pois_alguns_dados_enviados_devem_ser_numeros_inteiros(
    contratado, response
):
...
def test_cadastro_contratado_deve_falhar_devido_ao_tipo_atendimento_nao_ser_valido(
    app, contratado
):
