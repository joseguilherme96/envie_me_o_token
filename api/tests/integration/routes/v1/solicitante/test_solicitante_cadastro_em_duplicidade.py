...
def test_cadastro_deve_falhar_pois_ja_foi_cadastrado_um_solicitante_com_mesmo_codigo_solicitante(app, solicitante, codigo_solicitante, profissional_solicitante, conselho_profissional, numero_conselho_profissional, uf, cbos, request_fixture):
