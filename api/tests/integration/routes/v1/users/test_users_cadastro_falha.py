...
@mark.parametrize("login,senha,mensagem",[
    ...
    ("teste3e44ss3@test.com","12345678","A senha deve conter no minimo duas letras !")
])
def test_as_senhas_devem_ser_invalidadas(app, user_mark_parametrize_scope_function, mensagem):
