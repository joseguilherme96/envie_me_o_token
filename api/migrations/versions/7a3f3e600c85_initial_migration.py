...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Boolean(),
            nullable=False,
            comment="Define se beneficiário é rem nascido.",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=False,
            comment="1 - Eletiva, 2 - Urgência/Emergencia",
        ),
        sa.Column(
            "tipo_atendimento",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=False,
            comment="Nº de registro da operadora na ANS.",
        ),
        sa.Column(
            "operadora",
            sa.String(length=30),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=False,
            comment="Ver na guia do paciente.",
        ),
        sa.Column("codigo_execucao", sa.Integer(), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["codigo_execucao"],
            ["execucao_spsadt.codigo_execucao"],
        ),
    ...
    op.create_table(
        "transacao",
        sa.Column(
            "sequencia_transacao", sa.Integer(), autoincrement=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "codigo_status", sa.Integer(), nullable=False, comment="Ver tiss/schema."
        ),
        sa.Column("data_hora", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["codigo_transacao"],
            ["transacao.sequencia_transacao"],
        ),
